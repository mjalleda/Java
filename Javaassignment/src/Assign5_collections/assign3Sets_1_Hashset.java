/* Description: Here we learn about HashSets. To learn this, we need two classes.
Relationship: assign3_Hashset & assign3And4_SubClass_Employee are realted. 
assing3_EmployeeSubclass has Employee constructor, overrided equals and hashcode methods.
In this, I wrote 5 programs:
...
public class assign3Sets_1_Hashset {
	public static void main(String args[]) {
		...
		hs2.add(hs1);
		hs2.add(100);
		System.out.println(hs1); 	// Order is not preserved & Duplicate values doesnt print.
