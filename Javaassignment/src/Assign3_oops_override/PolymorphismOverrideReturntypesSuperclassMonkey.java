...
public class PolymorphismOverrideReturntypesSuperclassMonkey extends PolymorphismOverrideReturntypesSuperclassAnimal {
	public int legs = 4;
	public Boolean flies = false;
	public boolean wings = false;
	 PolymorphismOverrideReturntypesSuperclassMonkey m = new PolymorphismOverrideReturntypesSuperclassMonkey();
}
